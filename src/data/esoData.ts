...
const eso1_matematic: Ambit = {
  ...
  blocs: [
    ...
    mk("eso1-mat-nombres", "Mòdul 5 · Nombres i operacions", "➕", "bg-bloom-purple", [
      ...
      f("Resultat", "Result", "2+3=5", "Quin és el resultat?"),
      f("Fracció", "Fraction", "½", "Mitja pizza és una fracció."),
      f("Numerador", "Numerator", "³⁄_", "El numerador va a dalt."),
      f("Denominador", "Denominator", "_⁄₄", "El denominador va a baix."),
    ...
    mk("eso1-mat-algebra", "Mòdul 8 · Àlgebra bàsica", "🔣", "bg-primary", [
      ...
      f("Equació", "Equation", "2x+y=14", "Resol l'equació."),
      f("Igualtat", "Equality", "=", "A=B és una igualtat."),
      f("Variable", "Variable", "𝑥", "La variable és una lletra."),
      f("Terme", "Term", "+5𝑥", "Cada terme està separat per +."),
      f("Coeficient", "Coefficient", "3𝑥", "El coeficient és el nombre."),
...
const eso1_cientific: Ambit = {
  ...
  blocs: [
    ...
    mk("eso1-ct-dibuix-tecnic", "Dibuix tècnic", "📐", "bg-accent", [
      f("Croquis", "Sketch", "📝", "Fes un croquis abans del plànol."),
      f("Plànol", "Blueprint", "🗺️", "Mira el plànol de la casa."),
      f("Escala", "Scale", "1:100", "El plànol està a escala 1:100."),
      f("Vista frontal", "Front view", "🟦⬜⬜", "Dibuixa la vista frontal."),
      f("Vista lateral", "Side view", "⬜🟦⬜", "Aquesta és la vista lateral."),
      f("Vista de planta", "Top view", "⬜⬜🟦", "La vista de planta es veu des de dalt."),
      f("Acotació", "Dimensioning", "↔️", "Acota totes les mides."),
    ]),
    mk("eso1-ct-electricitat", "Electricitat i circuits", "💡", "bg-bloom-yellow", [
      ...
      f("Interruptor", "Switch", "🎚️", "Prem l'interruptor."),
      f("Polsador", "Push button", "🔘", "Prem el polsador per fer sonar el timbre."),
      f("Bombeta", "Bulb", "💡", "S'ha fos la bombeta."),
      f("Timbre", "Buzzer", "🔔", "El timbre sona quan tanques el circuit."),
      f("Resistència", "Resistor", "〰️", "La resistència limita el corrent."),
      f("Circuit", "Circuit", "⎓", "Munta el circuit elèctric."),
      f("Esquema elèctric", "Wiring diagram", "🔋—💡", "Dibuixa l'esquema elèctric del circuit."),
